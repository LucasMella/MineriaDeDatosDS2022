...
```{r}
#Mascaras
mask_agv <- readRDS("station_id_agv_Lucas.rds")
mask_agromet <- readRDS("station_id_agromet_Lucas.rds")

#Sets de datos
agv_meta <- readRDS("metadata_estaciones_agvAPI.rds")
api_agv <- readRDS("data_agvAPI.rds")
api_agromet <- readRDS("data_estaciones_agrometAPI.rds")
agromet_meta <- readRDS("metadata_estaciones_agrometAPI.rds")
